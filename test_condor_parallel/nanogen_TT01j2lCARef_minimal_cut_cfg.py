...
outfile = os.getenv('NANOGEN_OUTFILE', 'file:nanogen_TT01j2lCARef_minimal_cut.root')
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/eos/user/l/lingqian/EFT_FullRun2/gridpack/TT01j2lCARef_minimal_cut_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
