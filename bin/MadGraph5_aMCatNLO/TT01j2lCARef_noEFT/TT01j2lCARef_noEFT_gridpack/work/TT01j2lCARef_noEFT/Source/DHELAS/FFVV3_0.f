...
C     
      ...
      COMPLEX*16 VERTEX
      COMPLEX*16 COUP
      TMP27 = (F1(3)*(F2(3)*(V3(3)*(V4(3)+V4(6))+(V3(4)*(-1D0)*(V4(4)
     ...
     $ -V3(6)*(V4(3)+V4(6)))))))))
      TMP28 = (F1(3)*(F2(3)*(V3(3)*(V4(3)-V4(6))+(V3(4)*(+CI*(V4(5))
     ...
     $ +CI*(V4(4))-V4(5))-V3(6)*(V4(3)+V4(6)))))))
      TMP29 = (F1(5)*(F2(5)*(V3(3)*(V4(3)+V4(6))+(V3(4)*(+CI*(V4(5))
     $ -V4(4))+(V3(5)*(-1D0)*(V4(5)+CI*(V4(4)))-V3(6)*(V4(3)+V4(6)))))
     ...
     $ *(V3(3)*(V4(3)-V4(6))+(V3(4)*(-1D0)*(V4(4)+CI*(V4(5)))+(V3(5)*(
     $ +CI*(V4(4))-V4(5))+V3(6)*(V4(3)-V4(6)))))))
      VERTEX = COUP*(-CI*(TMP27)+CI*(TMP28+TMP29))
      END
