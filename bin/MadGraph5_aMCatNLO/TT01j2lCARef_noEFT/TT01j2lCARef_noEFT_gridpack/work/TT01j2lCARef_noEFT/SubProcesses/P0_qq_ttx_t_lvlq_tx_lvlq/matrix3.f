...
C     
C     Process: b b~ > t t~ NP<=1 NPprop=0 SMHLOOP=0 @0 NP=1 NPprop=0
C      SMHLOOP=0 
...
C     Amplitude(s) for diagram number 1
      CALL FFFF14_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_82,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFFF14_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_81,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFFF3_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_80,AMP(3))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,4),W(1,7),GC_2,AMP(4))
      CALL FFV1_3_3(W(1,1),W(1,2),GC_263,-GC_203,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
C     Amplitude(s) for diagram number 5
      CALL FFV1_3_0(W(1,5),W(1,4),W(1,7),GC_264,GC_203,AMP(5))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_6,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,4),W(1,7),GC_351,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,4),W(1,7),GC_6,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV9_0(W(1,5),W(1,4),W(1,7),GC_352,AMP(8))
      CALL FFS2_3(W(1,1),W(1,2),GC_566,MDL_MH, FK_MDL_WH,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFS2_0(W(1,5),W(1,4),W(1,7),GC_1025,AMP(9))
      CALL FFV3_3(W(1,1),W(1,4),GC_202,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV3_0(W(1,5),W(1,2),W(1,7),GC_202,AMP(10))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/6D0*AMP(1)-AMP(2)+1D0/6D0*AMP(3)+AMP(4)+AMP(5)
     $ -1D0/6D0*AMP(6)-1D0/6D0*AMP(7)-1D0/6D0*AMP(8)+AMP(9)
      JAMP(2,1)=-1D0/2D0*AMP(1)-1D0/2D0*AMP(3)+1D0/2D0*AMP(6)+1D0/2D0
     $ *AMP(7)+1D0/2D0*AMP(8)-AMP(10)
