...
C     
C     Process: d d~ > t t~ NP<=1 NPprop=0 SMHLOOP=0 @0 NP=1 NPprop=0
C      SMHLOOP=0 
...
C     Process: s s~ > t t~ NP<=1 NPprop=0 SMHLOOP=0 @0 NP=1 NPprop=0
C      SMHLOOP=0 
C     *   Decay: t > e+ ve b NP=0 NPprop=0 SMHLOOP=0 @0 NP=0 NPprop=0
C      SMHLOOP=0 
C     *   Decay: t~ > e- ve~ b~ NP=0 NPprop=0 SMHLOOP=0 @0 NP=0
...
C     Amplitude(s) for diagram number 1
      CALL FFFF14_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_113,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFFF16_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_64,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFFF15_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_95,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFFF14_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_112,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFFF3_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_67,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFFF3_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_68,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFFF15_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_96,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFFF16_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_65,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFFF3_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_72,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFFF3_0(W(1,5),W(1,2),W(1,1),W(1,4),-GC_69,AMP(10))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,5),W(1,4),W(1,7),GC_2,AMP(11))
      CALL FFV1_3_3(W(1,1),W(1,2),GC_263,-GC_203,MDL_MZ, FK_MDL_WZ,W(1
     $ ,7))
C     Amplitude(s) for diagram number 12
      CALL FFV1_3_0(W(1,5),W(1,4),W(1,7),GC_264,GC_203,AMP(12))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_6,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,5),W(1,4),W(1,7),GC_351,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,5),W(1,4),W(1,7),GC_6,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV9_0(W(1,5),W(1,4),W(1,7),GC_352,AMP(15))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/6D0*AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)+1D0/6D0
     $ *AMP(6)+1D0/6D0*AMP(7)+1D0/6D0*AMP(8)+1D0/6D0*AMP(9)-AMP(10)
     $ +AMP(11)+AMP(12)-1D0/6D0*AMP(13)-1D0/6D0*AMP(14)-1D0/6D0*AMP(15)
      JAMP(2,1)=+1D0/2D0*(-AMP(1)-AMP(6)-AMP(7)-AMP(8)-AMP(9)+AMP(13)
     $ +AMP(14)+AMP(15))
