...
C     
C     Process: u u~ > t t~ NP<=1 NPprop=0 SMHLOOP=0 @0 NP=1 NPprop=0
C      SMHLOOP=0 
...
C     Process: c c~ > t t~ NP<=1 NPprop=0 SMHLOOP=0 @0 NP=1 NPprop=0
C      SMHLOOP=0 
C     *   Decay: t > e+ ve b NP=0 NPprop=0 SMHLOOP=0 @0 NP=0 NPprop=0
C      SMHLOOP=0 
C     *   Decay: t~ > e- ve~ b~ NP=0 NPprop=0 SMHLOOP=0 @0 NP=0
...
C     Amplitude(s) for diagram number 1
      CALL FFFF13_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_112,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFFF4_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_67,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFFF4_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_68,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFFF17_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_91,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFFF18_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_117,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFFF13_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_113,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFFF18_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_116,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFFF17_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_92,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFFF4_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_70,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFFF4_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_73,AMP(10))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+AMP(1)+AMP(2)-1D0/6D0*AMP(3)+AMP(4)-1D0/6D0*AMP(5)
     $ -1D0/6D0*AMP(6)+AMP(7)-1D0/6D0*AMP(8)+AMP(9)-1D0/6D0*AMP(10)
     $ +AMP(11)+AMP(12)-1D0/6D0*AMP(13)-1D0/6D0*AMP(14)-1D0/6D0*AMP(15)
      JAMP(2,1)=+1D0/2D0*(+AMP(3)+AMP(5)+AMP(6)+AMP(8)+AMP(10)+AMP(13)
     $ +AMP(14)+AMP(15))
