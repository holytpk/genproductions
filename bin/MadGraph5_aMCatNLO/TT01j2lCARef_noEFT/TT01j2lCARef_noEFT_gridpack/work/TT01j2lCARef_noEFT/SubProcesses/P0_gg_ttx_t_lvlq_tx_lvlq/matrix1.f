...
C     
C     Process: g g > t t~ NP<=1 NPprop=0 SMHLOOP=0 @0 NP=1 NPprop=0
C      SMHLOOP=0 
...
C     Amplitude(s) for diagram number 1
      CALL FFVV3_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_386,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFVV1_0(W(1,5),W(1,4),W(1,1),W(1,2),GC_385,AMP(2))
      CALL VVV5P0_1(W(1,1),W(1,2),GC_7,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,4),W(1,7),GC_351,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,4),W(1,7),GC_6,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV9_0(W(1,5),W(1,4),W(1,7),GC_352,AMP(5))
      CALL FFV2_1(W(1,4),W(1,1),GC_351,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,5),W(1,7),W(1,2),GC_6,AMP(6))
      CALL FFV1_1(W(1,4),W(1,1),GC_6,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,5),W(1,7),W(1,2),GC_351,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,5),W(1,7),W(1,2),GC_6,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV9_0(W(1,5),W(1,7),W(1,2),GC_352,AMP(9))
      CALL FFV9_1(W(1,4),W(1,1),GC_352,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,5),W(1,7),W(1,2),GC_6,AMP(10))
      CALL FFV2_2(W(1,5),W(1,1),GC_351,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,7),W(1,4),W(1,2),GC_6,AMP(11))
      CALL FFV1_2(W(1,5),W(1,1),GC_6,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,7),W(1,4),W(1,2),GC_351,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,4),W(1,2),GC_6,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV9_0(W(1,7),W(1,4),W(1,2),GC_352,AMP(14))
      CALL FFV9_2(W(1,5),W(1,1),GC_352,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,7),W(1,4),W(1,2),GC_6,AMP(15))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-IMAG1*AMP(1)-IMAG1*AMP(2)-IMAG1*AMP(3)-IMAG1*AMP(4)
     $ -IMAG1*AMP(5)+AMP(6)+AMP(7)+AMP(8)+AMP(9)+AMP(10)
      JAMP(2,1)=+IMAG1*AMP(1)+IMAG1*AMP(2)+IMAG1*AMP(3)+IMAG1*AMP(4)
     $ +IMAG1*AMP(5)+AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15)
     ...
     $ +AMP(5))
      AMP2(6)=AMP2(6)+(AMP(6)+AMP(7)+AMP(8)+AMP(9)+AMP(10))
     $ *DCONJG(AMP(6)+AMP(7)+AMP(8)+AMP(9)+AMP(10))
      AMP2(11)=AMP2(11)+(AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15))
     $ *DCONJG(AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15))
      DO I = 1, NCOLOR
        DO M = 1, NAMPSO
          DO N = 1, NAMPSO
            IF (CHOSEN_SO_CONFIGS(SQSOINDEX1(M,N))) THEN
