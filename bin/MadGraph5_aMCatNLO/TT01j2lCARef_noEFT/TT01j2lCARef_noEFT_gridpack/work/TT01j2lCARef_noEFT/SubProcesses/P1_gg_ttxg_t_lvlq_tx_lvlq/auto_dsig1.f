...
C     Continue only if IMODE is 0, 4 or 5
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g g > e+ ve b e- ve~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > mu+ vm b e- ve~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > ta+ vt b e- ve~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e+ ve b mu- vm~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > mu+ vm b mu- vm~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > ta+ vt b mu- vm~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e+ ve b ta- vt~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > mu+ vm b ta- vt~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > ta+ vt b ta- vt~ b~ g
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IF (IMODE.EQ.4)THEN
        DSIG1 = PD(0)
