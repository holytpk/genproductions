...
C     
C     Process: g b~ > t t~ b~ NP<=1 NPprop=0 SMHLOOP=0 @1 NP=1
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1P0_3(W(1,7),W(1,2),GC_1,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1P0_3(W(1,7),W(1,2),GC_6,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,5),W(1,3),W(1,16),GC_6,AMP(13))
      CALL FFS2_3(W(1,7),W(1,2),GC_566,MDL_MH, FK_MDL_WH,W(1,17))
...
C     Amplitude(s) for diagram number 25
      CALL FFV3_0(W(1,7),W(1,3),W(1,13),GC_202,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV3_0(W(1,7),W(1,18),W(1,13),GC_202,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV3_0(W(1,7),W(1,19),W(1,13),GC_202,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFFF14_0(W(1,5),W(1,2),W(1,7),W(1,18),-GC_82,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFFF14_0(W(1,5),W(1,2),W(1,7),W(1,18),-GC_81,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFFF3_0(W(1,5),W(1,2),W(1,7),W(1,18),-GC_80,AMP(30))
      CALL FFV2_2(W(1,5),W(1,1),GC_351,MDL_MT, FK_MDL_WT,W(1,18))
      CALL FFV3_3(W(1,7),W(1,4),GC_202,MDL_MW, FK_MDL_WW,W(1,19))
...
C     Amplitude(s) for diagram number 48
      CALL FFFF14_0(W(1,13),W(1,2),W(1,7),W(1,4),-GC_82,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFFF14_0(W(1,13),W(1,2),W(1,7),W(1,4),-GC_81,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFFF3_0(W(1,13),W(1,2),W(1,7),W(1,4),-GC_80,AMP(50))
      CALL FFV1_1(W(1,2),W(1,1),GC_6,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 51
      CALL FFV3_0(W(1,5),W(1,13),W(1,19),GC_202,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,7),W(1,13),W(1,6),GC_1,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_3_0(W(1,7),W(1,13),W(1,8),GC_263,-GC_203,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,7),W(1,13),W(1,9),GC_6,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,7),W(1,13),W(1,10),GC_6,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,7),W(1,13),W(1,11),GC_6,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFS2_0(W(1,7),W(1,13),W(1,12),GC_566,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFFF14_0(W(1,5),W(1,13),W(1,7),W(1,4),-GC_82,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFFF14_0(W(1,5),W(1,13),W(1,7),W(1,4),-GC_81,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFFF3_0(W(1,5),W(1,13),W(1,7),W(1,4),-GC_80,AMP(60))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1D0/6D0*AMP(58)+AMP(59)-1D0/6D0*AMP(60)
      JAMP(3,1)=-AMP(11)-AMP(12)+1D0/6D0*AMP(13)-AMP(14)-AMP(15)
     ...
     $ -1D0/6D0*AMP(50)-AMP(64)-AMP(65)
      JAMP(4,1)=-1D0/2D0*AMP(3)-1D0/2D0*AMP(4)-1D0/2D0*AMP(5)+AMP(7)
