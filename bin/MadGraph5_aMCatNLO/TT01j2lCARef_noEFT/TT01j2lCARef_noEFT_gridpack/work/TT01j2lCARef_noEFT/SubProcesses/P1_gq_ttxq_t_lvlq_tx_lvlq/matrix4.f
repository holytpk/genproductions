...
C     
C     Process: g u~ > t t~ u~ NP<=1 NPprop=0 SMHLOOP=0 @1 NP=1
...
C      NPprop=0 SMHLOOP=0 
C     Process: g c~ > t t~ c~ NP<=1 NPprop=0 SMHLOOP=0 @1 NP=1
C      NPprop=0 SMHLOOP=0 
C     *   Decay: t > e+ ve b NP=0 NPprop=0 SMHLOOP=0 @0 NP=0 NPprop=0
C      SMHLOOP=0 
C     *   Decay: t~ > e- ve~ b~ NP=0 NPprop=0 SMHLOOP=0 @0 NP=0
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL IXXXXX(P(0,9),ZERO,NHEL(9),-1*IC(9),W(1,7))
      CALL FFV1_2(W(1,7),W(1,1),GC_6,ZERO, FK_ZERO,W(1,3))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_2,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,3),W(1,2),W(1,6),GC_2,AMP(1))
      CALL FFV1_3_3(W(1,5),W(1,4),GC_264,GC_203,MDL_MZ, FK_MDL_WZ,W(1
     $ ,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,8),GC_264,GC_203,AMP(2))
      CALL FFV2P0_3(W(1,5),W(1,4),GC_351,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,3),W(1,2),W(1,9),GC_6,AMP(3))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_6,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,3),W(1,2),W(1,10),GC_6,AMP(4))
      CALL FFV9P0_3(W(1,5),W(1,4),GC_352,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,3),W(1,2),W(1,11),GC_6,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFFF13_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_112,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFFF4_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_67,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFFF4_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_68,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFFF17_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_91,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFFF18_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_117,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFFF13_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_113,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFFF18_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_116,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFFF17_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_92,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFFF4_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_70,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFFF4_0(W(1,5),W(1,4),W(1,3),W(1,2),GC_73,AMP(15))
      CALL FFV2_1(W(1,4),W(1,1),GC_351,MDL_MT, FK_MDL_WT,W(1,3))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_2,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,5),W(1,3),W(1,12),GC_2,AMP(16))
      CALL FFV1_3_3(W(1,7),W(1,2),GC_264,GC_203,MDL_MZ, FK_MDL_WZ,W(1
     $ ,13))
C     Amplitude(s) for diagram number 17
      CALL FFV1_3_0(W(1,5),W(1,3),W(1,13),GC_264,GC_203,AMP(17))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_6,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 27
      CALL FFFF13_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_112,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFFF4_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_67,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFFF4_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_68,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFFF17_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_91,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFFF18_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_117,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFFF13_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_113,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFFF18_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_116,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFFF17_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_92,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFFF4_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_70,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFFF4_0(W(1,5),W(1,3),W(1,7),W(1,2),GC_73,AMP(36))
...
C     Amplitude(s) for diagram number 48
      CALL FFFF13_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_112,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFFF4_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_67,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFFF4_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_68,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFFF17_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_91,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFFF18_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_117,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFFF13_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_113,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFFF18_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_116,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFFF17_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_92,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFFF4_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_70,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFFF4_0(W(1,3),W(1,4),W(1,7),W(1,2),GC_73,AMP(57))
      CALL FFV1_1(W(1,2),W(1,1),GC_6,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,7),W(1,3),W(1,6),GC_2,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV1_3_0(W(1,7),W(1,3),W(1,8),GC_264,GC_203,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,7),W(1,3),W(1,9),GC_6,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,7),W(1,3),W(1,10),GC_6,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,7),W(1,3),W(1,11),GC_6,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFFF13_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_112,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFFF4_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_67,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFFF4_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_68,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFFF17_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_91,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL FFFF18_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_117,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFFF13_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_113,AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFFF18_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_116,AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFFF17_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_92,AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFFF4_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_70,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFFF4_0(W(1,5),W(1,4),W(1,7),W(1,3),GC_73,AMP(72))
...
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,7),W(1,2),W(1,14),GC_6,AMP(76))
      CALL FFVV1P0_3(W(1,5),W(1,4),W(1,1),GC_385,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,7),W(1,2),W(1,14),GC_6,AMP(77))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(-AMP(39)-AMP(42)-AMP(43)-AMP(44)-AMP(47)
     ...
     $ *AMP(74)-IMAG1*AMP(75)+IMAG1*AMP(76)+IMAG1*AMP(77))
      JAMP(2,1)=-AMP(1)-AMP(2)+1D0/6D0*AMP(3)+1D0/6D0*AMP(4)+1D0/6D0
     ...
     $ /6D0*AMP(68)-AMP(69)+1D0/6D0*AMP(70)-AMP(71)+1D0/6D0*AMP(72)
      JAMP(3,1)=-AMP(16)-AMP(17)+1D0/6D0*AMP(18)-AMP(19)-AMP(20)+1D0
     ...
     $ +1D0/6D0*AMP(57)
      JAMP(4,1)=+1D0/2D0*(-AMP(3)-AMP(4)-AMP(5)-AMP(8)-AMP(10)-AMP(11)
